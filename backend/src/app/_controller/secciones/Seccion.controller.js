...
const seccion_model_1 = require("./seccion.model");
class SeccionController {
    constructor(socket, io, user) {
        this.socket = socket;
        this.io = io;
        this.model = new seccion_model_1.SeccionModel();
        this.allEmpleados();
        this.EditSeccion();
        this.ListSeccion();
    }
    ...
    allEmpleados() {
        this.socket.on("allEmpleados", (data, callback) => __awaiter(this, void 0, void 0, function* () {
    ...
    ListSeccion() {
        this.socket.on("GetSeccion", (emit) => __awaiter(this, void 0, void 0, function* () {
            try {
                this.allSeccion();
            }
            catch (error) {
