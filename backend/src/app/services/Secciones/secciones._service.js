...
const SeccionesService = () => {
  ...
  app.get("/", middleware_1.middlewareToken, (req, res) =>
  ...
  app.get("/empleado/:id", middleware_1.middlewareToken, (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        const { id } = req.params;
  ...
  app.post("/", middleware_1.middlewareToken, (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        const json = req.body;
  ...
  app.put("/", middleware_1.middlewareToken, (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        const json = req.body;
