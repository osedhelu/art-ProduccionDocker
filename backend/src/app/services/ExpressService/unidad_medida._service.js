...
const UmedidaExpress = () => {
    ...
    app.post("/", _function_1.middlewareToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            _function_1.r._200(res, yield model.getUnidadMedidas({ ID_UN: req.my_data.ID_UN }));
        }
        catch (error) {
            interfaces_1._console.error(`unidad_medida._service _lin: 15 ==>>> ${JSON.stringify(error)}`);
